...
//  writeTiming.FSMC_AccessMode = FSMC_AccessMode_A;	 //模式A 
  ...
  FMC_NORSRAMInitStructure.FMC_Bank = FMC_Bank1_NORSRAM1;//  这里我们使用NE4 ，也就对应BTCR[6],[7]。
  ...
  FMC_NORSRAMInitStructure.FMC_MemoryDataWidth = FMC_NORSRAM_MemoryDataWidth_16b;//存储器数据宽度为16bit   FMC_NORSRAM_MemoryDataWidth_16b
